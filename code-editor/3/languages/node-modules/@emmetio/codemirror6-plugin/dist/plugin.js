...
import { EditorView, Decoration, showTooltip, ViewPlugin, keymap } from "https://codemirror.net/try/mods/@codemirror-view.js";
import { Facet, EditorState, StateEffect, StateField, EditorSelection } from "https://codemirror.net/try/mods/@codemirror-state.js";
import { htmlLanguage, html as html$1 } from "https://codemirror.net/try/mods/@codemirror-lang-html.js";
import { cssLanguage, css as css$1 } from "https://codemirror.net/try/mods/@codemirror-lang-css.js";
import { pickedCompletion, completionStatus, snippet } from "https://codemirror.net/try/mods/@codemirror-autocomplete.js";
import { syntaxTree, language, syntaxHighlighting, defaultHighlightStyle, HighlightStyle } from "https://codemirror.net/try/mods/@codemirror-language.js";
import { undo } from "https://codemirror.net/try/mods/@codemirror-commands.js";
...
function consumeNumber(scanner) {
  const start = scanner.pos;
  if (scanner.eat(46) && scanner.eatWhile(isNumber$1)) {
    return true;
  }
  if (scanner.eatWhile(isNumber$1) && (!scanner.eat(46) || scanner.eatWhile(isNumber$1))) {
    return true;
  }
  scanner.pos = start;
  return false;
